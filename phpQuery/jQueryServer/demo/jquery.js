...
jQuery.fn = jQuery.prototype = {
    ...
    clone: function (events) {
        ...
        var clone = ret.find("*").andSelf().each(
            function () {
...
function bindReady()
{
    ...
    // If Safari  is used
        ...
        jQuery.safariTimer = setInterval(
            function () {
...
jQuery.extend(
    ...
    speed: function (speed, easing, fn) {
        ...
        opt.duration =(
                ...
                opt.duration : 
                { slow: 600, fast: 200 }[opt.duration]
            ) || 400;
